...
#
# Generated by export_simulation on Thu Mar 17 16:54:58 EDT 2016
#
################################################################################
...
./KernelIntegrator_tb.sh

This command will launch the 'execute' function implemented in the script file
for the single-step flow. This function is called from the main 'run' function
in the script file.
...
switch to the './KernelIntegrator_tb.sh' script.

./KernelIntegrator_tb.sh -reset_run
...
./KernelIntegrator_tb.sh -noclean_files

For more information on the script, please type './KernelIntegrator_tb.sh -help'.
