-- -------------------------------------------------------------
-- 
-- File Name: Q:\Users\Qlab\Documents\Blake\iirfilter\hdlsrc\polyphaseIIR\Phase2_block.vhd
...
-- 
-- Module: Phase2_block
-- Source Path: polyphaseIIR/IIRDecimFilter/Stage2/Phase2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Phase2_block IS
...
BEGIN
  ...
  BEGIN
    IF rising_edge(clk) THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        delay1_1_1_out1 <= Input_signed;
      END IF;
    END IF;
  END PROCESS delay1_1_1_process;


  densum1_1_1_sub_temp <= (resize(Input_signed, 15)) - (resize(delay1_2_2_out1, 15));
  ...
  gain1_1_1_mul_temp <= 767 * densum1_1_1_out1;
  ...
  gain1_2_2_mul_temp <= 1634 * densum1_2_2_out1;
  ...
  BEGIN
    IF rising_edge(clk) THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        delay1_2_4_out1 <= numsum1_2_2_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF rising_edge(clk) THEN
      ...
      ELSIF enb_1_4_0 = '1' THEN
        delay1_2_5_out1 <= delay1_3_3_out1;
      END IF;
    END IF;
  ...
  densum1_3_3_sub_temp <= (resize(delay1_2_4_out1, 15)) - (resize(delay1_4_4_out1, 15));
  ...
  gain1_3_3_mul_temp <= 1990 * densum1_3_3_out1;
  ...
  numsum1_3_3_add_temp <= (resize(gain1_3_3_out1, 15)) + (resize(delay1_2_5_out1, 15));
  ...
  output <= std_logic_vector(numsum1_3_3_out1);
