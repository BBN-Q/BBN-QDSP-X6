...
ARCHITECTURE rtl OF Stage1 IS
  ...
  SIGNAL delay5_out1                      : signed(12 DOWNTO 0);  -- sfix13_En11
  ...
  SIGNAL delay4_out1                      : signed(12 DOWNTO 0);  -- sfix13_En11
  ...
  SIGNAL out_0_pipe1_reg                  : vector_of_signed14(0 TO 1);  -- sfix14 [2]
  SIGNAL delay6_out1_1                    : signed(13 DOWNTO 0);  -- sfix14_En11
  SIGNAL delay6_out1_2                    : signed(13 DOWNTO 0);  -- sfix14_En11
...
BEGIN
  ...
  BEGIN
    IF rising_edge(clk) THEN
      IF reset = '1' THEN
        delay5_reg <= (OTHERS => to_signed(2#0000000000000#, 13));
      ELSIF enb_1_2_0 = '1' THEN
        delay5_reg(0) <= Phase1_out1_signed;
  ...
  BEGIN
    IF rising_edge(clk) THEN
      IF reset = '1' THEN
        delay4_reg <= (OTHERS => to_signed(2#0000000000000#, 13));
      ELSIF enb_1_2_0 = '1' THEN
        delay4_reg(0) <= Phase2_out1_signed;
  ...
  Sum1_out1 <= (resize(delay5_out1, 14)) + (resize(delay4_out1, 14));
  ...
  BEGIN
    IF rising_edge(clk) THEN
      IF reset = '1' THEN
        out_0_pipe1_reg <= (OTHERS => to_signed(2#00000000000000#, 14));
      ELSIF enb_1_2_0 = '1' THEN
  ...
  BEGIN
    IF rising_edge(clk) THEN
      IF reset = '1' THEN
        delay6_out1_2 <= to_signed(2#00000000000000#, 14);
      ELSIF enb_1_2_0 = '1' THEN
